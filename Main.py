...
resize_shape = (256, 256)  # Resized image's shape 调整图像的形状
sigma = 10                 # Noise standard dev.  噪声标准差

window_shape = (16, 16)    # Patches' shape  批量大小，字典原子大小
step = 16                  # Patches' step
ratio = 1             # Ratio（比率） for the dictionary (training set).
ksvd_iter = 5              # Number of iterations for the K-SVD. 迭代次数
